...
describe('Date Range Parser', () => {
    ...
    it('should correctly parse strings', () => {
        const tests = [
            ...
            ['TO TODAY', {_min: null, _max: '2017-06-13T23:59:59.999Z'}],
    ...
    it('should correctly parse strings with timezone', () => {
        ...
        const tests = [
            ['TODAY', {_min: '2017-06-11T00:00:00.000-02:00', _max: '2017-06-11T23:59:59.999-02:00'}],
            ['YESTERDAY', {_min: '2017-06-10T00:00:00.000-02:00', _max: '2017-06-10T23:59:59.999-02:00'}],
            ['10 Jan 2017', {_min: '2017-01-10T00:00:00.000-02:00', _max: '2017-01-10T23:59:59.999-02:00'}],
            ['THIS   DAY', {_min: '2017-06-11T00:00:00.000-02:00', _max: '2017-06-11T23:59:59.999-02:00'}],
            ['PREVIOUS   DAY', {_min: '2017-06-10T00:00:00.000-02:00', _max: '2017-06-10T23:59:59.999-02:00'}],
            ['FROM 1 Dec 2010', {_min: '2010-12-01T00:00:00.000-02:00', _max: null}],
            ['FROM YESTERDAY', {_min: '2017-06-10T00:00:00.000-02:00', _max: null}],
            ['TO TODAY', {_min: null, _max: '2017-06-11T23:59:59.999-02:00'}],
            ['from 1 Dec 2010 to 1 Oct 2011', {_min: '2010-12-01T00:00:00.000-02:00', _max: '2011-10-01T23:59:59.999-02:00'}]
        ];
